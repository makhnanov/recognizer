...
- **مرشح السلبية** — يعيد كتابة الكلام الفظ أو المسيء بأسلوب مهذب تلقائياً (عتبة قابلة للتكوين)
...
- `FILTER_MODEL` — نموذج تحليل السلبية (الافتراضي: `gpt-4o-mini`)
- `NEGATIVITY_THRESHOLD` — عتبة نسبة السلبية لإعادة الكتابة (الافتراضي: `50`، `0` للتعطيل)
...
5. يحلل سلبية النص — إذا تجاوزت العتبة، يعيد كتابته بأسلوب مهذب
6. يكتشف نوع النافذة النشطة ويلصق النتيجة عبر Ctrl+Shift+V (الطرفيات) أو Ctrl+V (التطبيقات الأخرى)، مع الحفاظ على الحافظة الأصلية
